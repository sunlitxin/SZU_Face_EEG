...
def load_pkl_datas(base_path):
    # 获取目录下所有的 PKL 文件路径
    pkl_file_paths = [os.path.join(base_path, f) for f in os.listdir(base_path) if f.endswith('.pkl')]
...
def main():
    ...
    all_eeg_data, all_labels = load_pkl_datas(base_path)
